...
import codebase.baseline as baseline
import codebase.cvae as cvae
import pandas as pd
import torch
from codebase.cvae_util import generate_table, get_data, visualize
...
def main(args):
    ...
    for num_quadrant_inputs in args.num_quadrant_inputs:
        ...
        # Dataset
        # datasets, dataloaders, dataset_sizes = get_data(batch_size=128)
        datasets, dataloaders, dataset_sizes = get_data(pos=num_quadrant_inputs, batch_size=16)
        ...
        visualize(
            ...
            image_path="cvae_plot{}.png".format(num_quadrant_inputs),
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-esp", "--early-stop-patience", default=20, type=int, help="early stop patience"
    )
    parser.add_argument(
